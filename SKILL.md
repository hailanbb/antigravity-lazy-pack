...
description: AntiGravity 懶人包 — 全套開發環境、全域設定、WPS 操控、中文漢化、Firecrawl 及工作流程還原。說「AntiGravity 懶人包」「還原 Antigravity 設定」時載入。
---
...
| **11** | `11-chinese-localization` | **【NEW】離線一鍵漢化與還原管理面板（安全注入中文 UI DOM 翻譯引擎）** |
